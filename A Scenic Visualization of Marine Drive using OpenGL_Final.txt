...
{
    glBegin(GL_QUADS);
    glColor3f(0.2f, 0.4f, 0.8f); // Elegant deep blue window glass
...
void building()
{
    ...
    glColor3f(0.96f, 0.87f, 0.70f); // Soft beige front wall
    glVertex2f(0.0f, 0.0f);
    ...
    float x=0.15f;
    float m=1.67f;
    glColor3f(0.72f, 0.52f, 0.37f); // Muted brown side wall
    glVertex2f(0.5f, 0.0f);
    glVertex2f(0.5f, 0.6f);
    glVertex2f(0.5f+x, 0.6f+x*m);
    glVertex2f(0.5f+x, 0.0f+x*m);

    glColor3f(0.87f, 0.41f, 0.28f); // Terracotta orange roof
    glVertex2f(0.0f, 0.6f);
    glVertex2f(0.5f, 0.6f);
    glVertex2f(0.5f+x, 0.6f+x*m);
...
void mosque()
{
    /// right side wall
    glBegin(GL_POLYGON);
    glColor3f(0.75f, 0.78f, 0.75f); // medium light gray wall for contrast
    ...
    glBegin(GL_POLYGON);
    glColor4f(1.0f, 0.80f, 0.1f, 0.35f); // richer transparent gold
    ...
    /// top wall
    glBegin(GL_POLYGON);
    glColor3f(0.80f, 0.82f, 0.80f); // medium light gray top wall for contrast
    ...
    /// golden trim line
    glBegin(GL_POLYGON);
    glColor3f(1.0f, 0.85f, 0.3f); // richer gold trim
    glVertex2f(getX(-350), getY(150));
    glVertex2f(getX(-100), getY(150));
    ...
    /// front wall
    glBegin(GL_POLYGON);
    glColor3f(0.88f, 0.89f, 0.88f); // soft off-white front wall with slight gray tint
    ...
    /// mosque doors
    glColor3f(0.8f, 0.55f, 0.25f); // warmer, richer brown doors
    ...
    auto drawDome = [](float tx, float ty, float r, float dr=1.0f, float dg=0.88f, float db=0.3f) {
        glPushMatrix();
        glEnable(GL_BLEND);
    ...
    drawDome(-.305, 0.23, 0.03); // richer gold dome
    ...
    /// minarets
    glColor3f(0.65f, 0.65f, 0.65f); // medium gray minarets for better visibility
    ...
    /// crescent moon
    glColor3f(1.0f, 0.85f, 0.1f); // bright gold crescent
...
void villageHouse()
{
    /// front - terracotta red
    glColor3ub(205, 92, 92); // IndianRed
    glBegin(GL_QUADS);
    glVertex2f(0, 0);
    glVertex2f(0, 0.4);
    glVertex2f(0.5, 0.4);
    ...
    /// right - medium sea green
    glColor3f(0.28f, 0.65f, 0.55f);
    glBegin(GL_QUADS);
    ...
    /// front top - golden sand
    glColor3ub(238, 232, 170); // pale goldenrod
    glBegin(GL_TRIANGLES);
    glVertex2f(0, 0.4);
    glVertex2f(0.5, 0.4);
    glVertex2f(0.25, 0.6);
    ...
    /// right top - coral highlight
    glColor3ub(255, 127, 80); // coral
    glBegin(GL_QUADS);
    glVertex2f(0.25, 0.6);
    glVertex2f(0.5, 0.4);
    glVertex2f(0.7, 0.4 + 0.2 * 1.67);
    ...
    /// left window - mint
    glColor3ub(152, 255, 152); // PaleGreen
    glBegin(GL_QUADS);
    glVertex2f(0.1, 0.2);
    glVertex2f(0.1, 0.3);
    glVertex2f(0.2, 0.3);
    ...
    glColor3f(0, 0, 0);
    glBegin(GL_LINES);
    glVertex2f(0.11, 0.2); glVertex2f(0.11, 0.3);
    glVertex2f(0.13, 0.2); glVertex2f(0.13, 0.3);
    glVertex2f(0.15, 0.2); glVertex2f(0.15, 0.3);
    glVertex2f(0.17, 0.2); glVertex2f(0.17, 0.3);
    glVertex2f(0.19, 0.2); glVertex2f(0.19, 0.3);
    glEnd();
    ...
    glColor3f(0, 0, 0);
    glBegin(GL_LINES);
    glVertex2f(0.31, 0.2); glVertex2f(0.31, 0.3);
    glVertex2f(0.33, 0.2); glVertex2f(0.33, 0.3);
    glVertex2f(0.35, 0.2); glVertex2f(0.35, 0.3);
    glVertex2f(0.37, 0.2); glVertex2f(0.37, 0.3);
    glVertex2f(0.39, 0.2); glVertex2f(0.39, 0.3);
    glEnd();
}
...
void villageHouse2()
{
    /// front wall - warm ochre
    glColor3f(0.87f, 0.64f, 0.12f);
    glBegin(GL_QUADS);
    glVertex2f(0, 0);
    glVertex2f(0, 0.25);
    glVertex2f(0.5, 0.25);
    ...
    /// right side top - soft red
    glColor3f(0.85f, 0.4f, 0.4f);
    glBegin(GL_TRIANGLES);
    glVertex2f(0.5, 0.25);
    glVertex2f(0.6, 0.35);
    glVertex2f(0.72, 0.3);
    ...
    /// right side wall - soft brown
    glColor3f(0.60f, 0.38f, 0.30f);
    glBegin(GL_QUADS);
    glVertex2f(0.5, 0);
    glVertex2f(0.5, 0.25);
    glVertex2f(0.72, 0.3);
    ...
    glColor3f(0.25f, 0.1f, 0.05f); // darker border lines
    glBegin(GL_LINES);
    glVertex2f(0.2, 0); glVertex2f(0.2, 0.15);
    glVertex2f(0.2, 0.15); glVertex2f(0.3, 0.15);
    glVertex2f(0.3, 0.15); glVertex2f(0.3, 0);
    glVertex2f(0.3, 0); glVertex2f(0.2, 0);
    glEnd();

    /// left front window - light tan
    ...
    glBegin(GL_LINES);
    glVertex2f(0.05, 0.10); glVertex2f(0.05, 0.16);
    glVertex2f(0.05, 0.16); glVertex2f(0.15, 0.16);
    glVertex2f(0.15, 0.16); glVertex2f(0.15, 0.10);
    glVertex2f(0.15, 0.10); glVertex2f(0.05, 0.10);
    glEnd();

    /// grill
    glColor3f(0.0f, 0.0f, 0.0f);
    glBegin(GL_LINES);
    glVertex2f(0.06, 0.10); glVertex2f(0.06, 0.16);
    glVertex2f(0.08, 0.10); glVertex2f(0.08, 0.16);
    glVertex2f(0.10, 0.10); glVertex2f(0.10, 0.16);
    glVertex2f(0.12, 0.10); glVertex2f(0.12, 0.16);
    glVertex2f(0.14, 0.10); glVertex2f(0.14, 0.16);
    glEnd();

    /// right front window - same as left
    glColor3f(0.93f, 0.78f, 0.62f);
    glBegin(GL_QUADS);
    ...
    glColor3f(0.0f, 0.0f, 0.0f);
    glBegin(GL_LINES);
    glVertex2f(0.36, 0.10); glVertex2f(0.36, 0.16);
    glVertex2f(0.38, 0.10); glVertex2f(0.38, 0.16);
    glVertex2f(0.40, 0.10); glVertex2f(0.40, 0.16);
    glVertex2f(0.42, 0.10); glVertex2f(0.42, 0.16);
    glVertex2f(0.44, 0.10); glVertex2f(0.44, 0.16);
    glEnd();

    /// right side window - light clay
    glColor3f(0.85f, 0.6f, 0.45f);
    glBegin(GL_QUADS);
    glVertex2f(0.56, 0.1);
    glVertex2f(0.56, 0.2);
    ...
    glColor3f(0.0f, 0.0f, 0.0f);
    glBegin(GL_LINES);
    glVertex2f(0.57, 0.2+0.01*0.23); glVertex2f(0.57, 0.1+0.01*0.23);
    glVertex2f(0.585, 0.2+0.025*0.23); glVertex2f(0.585, 0.1+0.025*0.23);
    glVertex2f(0.6, 0.2+0.04*0.23); glVertex2f(0.6, 0.1+0.04*0.23);
    glVertex2f(0.615, 0.2+0.055*0.23); glVertex2f(0.615, 0.1+0.055*0.23+0.005);
    glVertex2f(0.63, 0.2+0.07*0.23); glVertex2f(0.63, 0.1+0.07*0.23+0.005);
    glVertex2f(0.645, 0.2+0.085*0.23); glVertex2f(0.645, 0.1+0.085*0.23+0.005);
    glEnd();
}
